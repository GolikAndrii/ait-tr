    ...
    public static void main(String[] args) throws IOException {
        ...
        if (monthDays.containsKey(monthToLook)) {
            ...
            switch (monthToLook.ordinal()) {
                case 0, 1, 11 -> System.out.println("This month belongs to " + Seasons.WINTER);
                case 2, 3, 4 -> System.out.println("This month belongs to " + Seasons.SPRING);
                case 5, 6, 7 -> System.out.println("This month belongs to " + Seasons.SUMMER);
                default -> System.out.println("This month belongs to " + Seasons.AUTUMN);
            }
